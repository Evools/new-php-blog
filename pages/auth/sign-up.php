...
if (isset($_POST['register'])) {
  ...
  if (empty($password)) {
    $error['password'] = "Поле пароля не должно пыть пустым";
  }
  if (empty($confirm)) {
      ...
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form class="space-y-4 md:space-y-6" action="sign-up" method="post">
          ...
          <div>
            ...
            <input type="password" name="confirm" id="confirm" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" required="">
          </div>
