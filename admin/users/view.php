              ...
              <tr class="bg-white border-b hover:bg-gray-50" data-role="<?= $user['role']; ?>">
                ...
                <td class="px-6 py-4">
                  <div class="flex gap-2">
                    <a href="/admin/users/edit/<?= $user['id'] ?>" class="inline-flex items-center gap-1 px-3 py-1.5 border border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white rounded-md transition-colors duration-200">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                      </svg>
                      Редактировать
                    </a>
                    <button onclick="openDeleteModal(<?= $user['id']; ?>, '<?= htmlspecialchars($user['name']); ?>')" class="inline-flex items-center gap-1 px-3 py-1.5 border border-red-600 text-red-600 hover:bg-red-600 hover:text-white rounded-md transition-colors duration-200">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
