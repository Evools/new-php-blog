...
<main>
  ...
  <div class="p-4 sm:ml-64 mt-16">
    ...
    <div class="mb-4 flex gap-4">
      <div class="flex-1">
        <input type="text" placeholder="Поиск пользователей..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
      </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <table class="w-full text-sm text-left text-gray-500">
          ...
          <tbody>
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
              ...
              <td class="px-6 py-4 font-medium text-gray-900">Иван Иванов</td>
              <td class="px-6 py-4">ivan@example.com</td>
              <td class="px-6 py-4">
            ...
            <tr class="bg-white border-b hover:bg-gray-50">
              ...
              <td class="px-6 py-4 font-medium text-gray-900">Петр Петров</td>
              <td class="px-6 py-4">petr@example.com</td>
              <td class="px-6 py-4">
        ...
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
          <div class="mt-3 text-center">
            ...
            <div class="mt-2 px-7 py-3">
              <p class="text-gray-500">Это действие нельзя будет отменить.</p>
            </div>
            <div class="flex justify-center gap-3 mt-3">
              <button onclick="closeDeleteModal()" class="px-4 py-2 bg-gray-200 text-gray-800 rounded-lg hover:bg-gray-300">Отмена</button>
              <button class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">Удалить</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="flex items-center justify-between p-4 border-t">
        ...
        <div class="flex gap-2">
          ...
          <button class="px-3 py-1 text-sm text-white bg-blue-600 rounded hover:bg-blue-700">Вперед</button>
        </div>
      </div>
    </div>
  </div>
